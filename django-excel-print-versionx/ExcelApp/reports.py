...
class reports(object):
	...
	def r3(res):
		#workbook = xlsxwriter.Workbook('C:/Users/xuh/Documents/Nursery Inspection Report.xlsx')
		output = BytesIO() # new IO
		workbook = xlsxwriter.Workbook(output) #new IO
